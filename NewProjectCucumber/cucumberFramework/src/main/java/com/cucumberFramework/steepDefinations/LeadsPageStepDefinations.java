...
import com.cucumberFramework.pageObject.LeadsCreationsPage;
import com.cucumberFramework.pageObject.LeadsVerificationPage;
...
public class LeadsPageStepDefinations extends TestBase{
	
	LeadsCreationsPage leadsPage = new LeadsCreationsPage(driver);
	LeadsVerificationPage leadsVerificationPage = new LeadsVerificationPage(driver);
	WaitHelper waitHelper = new WaitHelper(driver);
	
	Logger log = LoggerHelper.getLogger(LeadsPageStepDefinations.class);
	
	@When("^I click on leads link$")
	public void i_click_on_leads_link() throws Throwable {
		leadsPage.ClickingOnLeads();
	}
