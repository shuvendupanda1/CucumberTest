...
public class LeadsCreationsPage {
	
	WebDriver driver;
	private WaitHelper waitHelper;

	private static Logger log = LoggerHelper.getLogger(LeadsCreationsPage.class);
	
	@FindBy(xpath="//td[@class='small']/table/tbody/tr/td/a[contains(text(),'Leads')]")
	...
	public LeadsCreationsPage(WebDriver driver) {
		this.driver = driver;
